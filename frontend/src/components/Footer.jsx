        ...
        <footer className="bg-slate-900 text-gray-300 mt-20 border-t border-slate-800">
            <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <a
                                href="#"
                                aria-label="WhatsApp"
                                className="w-9 h-9 rounded-xl bg-slate-800 hover:bg-emerald-600 flex items-center justify-center transition-colors duration-200"
                            >
                                <svg className="w-4 h-4 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between text-xs text-gray-500">
                    <p className="mb-4 md:mb-0">&copy; {YEAR} KatalogKITA. Hak Cipta Dilindungi Undang-Undang.</p>
